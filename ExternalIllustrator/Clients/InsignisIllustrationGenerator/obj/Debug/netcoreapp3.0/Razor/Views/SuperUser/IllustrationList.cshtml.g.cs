#pragma checksum "D:\insignis\ExternalIllustrator\Clients\InsignisIllustrationGenerator\Views\SuperUser\IllustrationList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5ed92f9889ee5ba9849caac3cc217666e6715fa7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5ed92f9889ee5ba9849caac3cc217666e6715fa7", @"/Views/SuperUser/IllustrationList.cshtml")]
        ...
        $.ajax({
            ...
            WriteLiteral(@"= false) {
                    ...
                    $.each(response.data, function () {
                        ...
                        $("".illustrationListTable tbody"").append('<tr class=""d-flex"" id=""bankDetailRow""><td class=""col-md-1"" style=""min-width:112px;"">' + this.adviserName + '</td><td class=""col-md-1"" style=""min-width:130px"">' + this.clientName + '</td><td class=""col-md-2"" style=""min-width:180px"">' + this.partnerOrganisation + '</td><td class=""col-md-2"" style=""min-width:260px"" >' + this.illustrationUniqueReference + '<input type=""hidden"" id=""item_IllustrationUniqueReference"" value=""' + this.illustrationUniqueReference");
            WriteLiteral(@" + '""/></td><td class=""col-md-2"" style=""min-width:170px"">' + this.generateDate.split(""T"")[0] + '</td><td class=""col-md-1"" style=""min-width:89px"">' + this.status + '</td></tr>');
                    });
                }
