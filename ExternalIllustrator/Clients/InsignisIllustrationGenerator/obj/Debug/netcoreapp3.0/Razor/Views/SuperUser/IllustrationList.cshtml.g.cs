#pragma checksum "D:\insignis\ExternalIllustrator\Clients\InsignisIllustrationGenerator\Views\SuperUser\IllustrationList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8fd538d6c12e1c122b584774bd02ef61045637c3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8fd538d6c12e1c122b584774bd02ef61045637c3", @"/Views/SuperUser/IllustrationList.cshtml")]
...
");
            WriteLiteral("                            ");
#nullable restore
#line 52 "D:\insignis\ExternalIllustrator\Clients\InsignisIllustrationGenerator\Views\SuperUser\IllustrationList.cshtml"
...
#nullable restore
#line 63 "D:\insignis\ExternalIllustrator\Clients\InsignisIllustrationGenerator\Views\SuperUser\IllustrationList.cshtml"
     ...
     var LoadData = function () {
        $.ajax({
            ...
            success: function (response, textStatus, jqXHR) {
              ...
              ");
            WriteLiteral(@"  tbl += '     <tr class=""d-flex"">';
            ...
            WriteLiteral(@"= false) {
                    ...
                    for (var i = 0; i < response.data.length; i++) {
                        $('#validationerror').append(response.data[i]);
                    }
                    ...
                    $.each(response.data, function () {
                        ...
                        $("".illustrationListTable tbody"").append('<tr class=""d-flex"" id=""bankDetailRow""><td class=""col-md-1"" style=""min-width:112px;"">' + this.adviserName + '</td><td class=""col-md-1"" style=""min-width:130px"">' + this.clientName + '</td><td class=""col-md-2"" style=""min-width:180px"">' + this.partnerOrganisation + '</td><td class=""col-md-2"" style=""min-width:260px"" >' + this.illustrationUniqueReference + '<input type=""hidden"" id=""item_IllustrationUniqueReference"" value=""' + this.illustrationUniqueReference + '""/></td><td class=""col-md-2"" style=""min-width:170px"">' + this.generateDate + '</td><td class=""col-md-1""");
            WriteLiteral(@" style=""min-width:89px"">' + this.status + '</td></tr>');
                    });
                }
