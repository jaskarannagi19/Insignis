#pragma checksum "D:\insignis\ExternalIllustrator\Clients\InsignisIllustrationGenerator\Views\SuperUser\IllustrationList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "eac11235ccd9145aed19131328fce190843c9fea"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"eac11235ccd9145aed19131328fce190843c9fea", @"/Views/SuperUser/IllustrationList.cshtml")]
    ...
    var LoadData = function () {
        $.ajax({
            ...
            success: function (response, textStatus, jqXHR) {
                ...
                tbl += '     <tr class=""d-flex"">';
                tbl += '      ");
            WriteLiteral(@"   <th class=""col-2"">Advisor Name</th>';
                ...
                if (response.success === false) {
                    ...
                    $.each(response.data, function () {
                        $(""#tblbody"").append('<tr class=""d-flex"" id=""bankDetailRow""    ><td class=""col-2"">' + this.adviserName + '</td><td class=""col-2""");
            WriteLiteral(@">' + this.clientName + '</td><td class=""col-2"">' + this.partnerOrganisation + '</td><td class=""col-3"">' + this.illustrationUniqueReference + '<input type=""hidden"" id=""item_IllustrationUniqueReference"" value=""' + this.illustrationUniqueReference + '""/></td><td class=""col-2"">' + this.generateDate + '</td><td class=""col-1"">' + this.status + '</td></tr>');
                    });
                    //var data = response.data;
                    //for (var i = 0; i < data.length; i++) {
                    //    $('#illustrationListTable tr:last').after('<tr class=""d-flex"" id=""bankDetailRow"" onclick=""RedirectIllustrationDetail()""  ><td class=""col-2"">' + data[i].adviserName + '</td><td class=""col-2"">' + data[i].clientName + '</td><td class=""col-2"">' + data[i].partnerOrganisation + '</td><td class=""col-3"">' + data[i].illustrationUniqueReference + '<input type=""hidden"" id=""item_IllustrationUniqueReference"" value=""' + data[i].illustrationUniqueReference + '""/></td><td class=""col-2"">' + data[i].generateDate + '</");
            WriteLiteral(@"td><td class=""col-1"">' + data[i].status + '</td></tr>');
                    //}
