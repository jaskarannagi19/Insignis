#pragma checksum "D:\insignis\ExternalIllustrator\Clients\InsignisIllustrationGenerator\Views\SuperUser\IllustrationList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b5a5a242652c8c7dea8803acf79e6cd550bda738"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b5a5a242652c8c7dea8803acf79e6cd550bda738", @"/Views/SuperUser/IllustrationList.cshtml")]
...
");
    ...
    ");
            WriteLiteral(@"                $.each(response.data, function () {
                    ...
                    //    $('#illustrationListTable tr:last').after('<tr class=""d-flex"" id=""bankDetailRow"" onclick=""RedirectIllustrationDetail()""  ><td class=""col-2"">' + data[i].adviserName + '</td><td class=""col-2"">' + data[i].clientName + '</td><td class=""col-2"">' + data[i].partnerOrganisation + '</td><td class=""col-3"">' +");
            WriteLiteral(@" data[i].illustrationUniqueReference + '<input type=""hidden"" id=""item_IllustrationUniqueReference"" value=""' + data[i].illustrationUniqueReference + '""/></td><td class=""col-2"">' + data[i].generateDate + '</td><td class=""col-1"">' + data[i].status + '</td></tr>');
                    //}
