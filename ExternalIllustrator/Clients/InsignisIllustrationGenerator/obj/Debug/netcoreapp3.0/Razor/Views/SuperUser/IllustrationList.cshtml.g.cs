#pragma checksum "D:\insignis\ExternalIllustrator\Clients\InsignisIllustrationGenerator\Views\SuperUser\IllustrationList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a8a024e6c592844f719450d2c32d1de0aa91985a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a8a024e6c592844f719450d2c32d1de0aa91985a", @"/Views/SuperUser/IllustrationList.cshtml")]
     ...
     var LoadData = function () {
        $.ajax({
            ...
            WriteLiteral(@"  tbl += '     <tr class=""d-flex"">';
                tbl += '         <th class=""col-md-1"">Advisor Name</th>';
                tbl += '         <th class=""col-md-1"">Client Name</th>';
                tbl += '         <th class=""col-md-2"">Company Name</th>';
                tbl += '         <th class=""col-md-2"">Illustration Unique Reference</th>';
            ...
            WriteLiteral(@"  }
                    ...
                    $.each(response.data, function () {
                        $("".illustrationListTable tbody"").append('<tr class=""d-flex"" id=""bankDetailRow""><td class=""col-md-1"">' + this.adviserName + '</td><td class=""col-md-1"">' + this.clientName + '</td><td class=""col-md-2"">' + this.partnerOrganisation + '</td><td class=""col-md-2"">' + this.illustrationUniqueReference + '<input type=""hidden"" id=""item_IllustrationUniqueReference"" value=""' + this.illustrationUniqueReference + '""/></td><td class=""col-md-2"">' + this.generateDate + '</td><td class=""col-md-1"">' + this.status + '</td></tr>');
                    });
                }
