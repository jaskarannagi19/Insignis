#pragma checksum "D:\insignis\ExternalIllustrator\Clients\InsignisIllustrationGenerator\Views\SuperUser\IllustrationList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0d24b2b4d498f063c8f610fa7844cbc3fb750c8f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0d24b2b4d498f063c8f610fa7844cbc3fb750c8f", @"/Views/SuperUser/IllustrationList.cshtml")]
        ...
        $.ajax({
            ...
            WriteLiteral(@"= false) {
                    ...
                    $.each(response.data, function () {
                        ...
                        $("".illustrationListTable tbody"").append('<tr class=""d-flex"" id=""bankDetailRow""><td class=""col-md-1"" style=""min-width:112px;"">' + this.partnerName + '</td><td class=""col-md-1"" style=""min-width:130px"">' + this.clientName + '</td><td class=""col-md-2"" style=""min-width:180px"">' + this.partnerOrganisation + '</td><td class=""col-md-2"" style=""min-width:260px"" >' + this.illustrationUniqueReference");
            WriteLiteral(@" + '<input type=""hidden"" id=""item_IllustrationUniqueReference"" value=""' + this.illustrationUniqueReference + '""/></td><td class=""col-md-2"" style=""min-width:170px"">' + date[2]+""/""+date[1]+""/""+date[0]  + '</td><td class=""col-md-1"" style=""min-width:89px"">' + this.status + '</td></tr>');
                    });
                }
