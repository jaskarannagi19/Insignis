...
{
    public class TransparentRow : BaseRow
    {
        public TransparentRow()
        {
        }

        public TransparentRow(XmlElement pRoot)
        {
            try
            {
                if (pRoot.Name.CompareTo("transparentRow") == 0)
                {
